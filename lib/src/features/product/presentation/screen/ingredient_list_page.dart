...
import 'package:byutinagae/src/features/product/presentation/widget/ingredient_composition.dart';
import 'package:byutinagae/src/features/product/presentation/widget/ingredient_info_bottom_sheet.dart';
import 'package:byutinagae/src/features/product/presentation/widget/ingredient_list_tile.dart';
                  ...
                  onPressed: () async {
                    ...
                    showDialog(
                      ...
                      builder: (context) => CustomSmallDialog(
                        cancelFun: () async => Navigator.pop(context),
                        cancelText: '아니요',
                        completeText: '보내기',
                        content:
