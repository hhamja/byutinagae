...
mixin _$DetailProductModel {
  String get id => throw _privateConstructorUsedError; // 풀 사이즈 이미지 url
  @ImageUrlConverter()
...
// 가격
  ...
  @override
  String toString() {
    return 'DetailProductModel(id: $id, fullImage: $fullImage, brand: $brand, productName: $productName, volume: $volume, price: $price)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, fullImage, brand, productName, volume, price);
...
abstract class _DetailProductModel implements DetailProductModel {
  const factory _DetailProductModel(
      ...
      @PriceConverter() required final String price}) = _$_DetailProductModel;
